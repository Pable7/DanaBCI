...
public class Valores extends AppCompatActivity {
        ...
        bloquear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (active) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder( Valores.this);
    ...
    private void initComponents(){
        ...
        compName = new ComponentName(Valores.this, Lock.class);

        volumen = findViewById(R.id.SkBr_Volumen);
        audioManager = (AudioManager) Valores.this.getSystemService(Context.AUDIO_SERVICE);
        ...
        switch(requestCode) {
            case RESULT_ENABLE :
                if ( resultCode == Activity.RESULT_OK) {
                    Toast.makeText( Valores.this, "You have enabled the Admin Device features", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText( Valores.this, "Problem to enable the Admin Device features", Toast.LENGTH_SHORT).show();
                }
                break;
        }
